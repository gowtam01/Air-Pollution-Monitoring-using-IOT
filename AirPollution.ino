...
short int idx_data_15_sec = 0;    // 15 sec index = 0
short int idx_data_10_min = 0;    // 10 minute index = 0
short int hist_start_idx = 0;     // starting history index = 0 


//Making history index false
...
//    hw_read_gas(&data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].co,
//                &data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].no2,
//                &data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].nh3);
//
//    hw_read_co2(&data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].CO2);
//
//    hw_read_noise(&data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].noise);
//
//    hw_read_so2(&data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].so2);

//    data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].aqi = compute_index_aqi(
//          data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].pm25,
//          data_15_sec[idx_data_15_sec % PRIMARY_BUF_COUNT].pm10);
//
//    debug_info("AQI: ");
...
//      sum_noise += data_15_sec[i % max].noise;
    ...
    */
    ...
    data_10_min[idx_data_10_min % max_buf].rh = sum_rh
        / no_records;
//    data_10_min[idx_data_10_min % max_buf].co = sum_co
//        / no_records;
//    data_10_min[idx_data_10_min % max_buf].no2 = sum_no2
//        / no_records;
//    data_10_min[idx_data_10_min % max_buf].nh3 = sum_nh3
//        / no_records;
//    data_10_min[idx_data_10_min % max_buf].CO2 = sum_co2
//        / no_records;
//    data_10_min[idx_data_10_min % max_buf].noise = sum_noise
//        / no_records;
